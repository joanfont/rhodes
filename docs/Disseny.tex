...
\subsubsection{Obtenció dels grups de cada assignatura}
	...
	Aquesta petició rebrà com a paràmetre al \emph{query string} l'identificador únic de l'assignatura. Al camp \texttt{items} de l'embolcall paginat hi haurà registres amb el següent format:
