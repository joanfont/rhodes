...
\end{verbatim}
\end{itemize}
\subsection{\emph{NotAuthenticatedError}}
\begin{itemize}
...
\end{verbatim}
\end{itemize}
\subsection{\emph{GroupDoesNotBelongToSubjectError}}
\begin{itemize}
...
\end{verbatim}
\end{itemize}
\subsection{\emph{StudentIsNotEnrolledToGroupError}}
\begin{itemize}
...
\end{verbatim}
\end{itemize}
\subsection{\emph{MediaNotFoundError}}
\begin{itemize}
...
\end{verbatim}
\end{itemize}
\subsection{\emph{MessageDoesNotBelongToConversationError}}
	...
	\begin{verbatim}
{
  ...
  "groups": [
    {
      "body": "Lorem ipsum dolor sit amet a14575d8-821a-4474-a3ca-eb95aacd2c21",
      "sender": {
        "first_name": "Joan",
        "last_name": "Font",
        "avatar": null,
